...
export const PAVOS: FortniteProduct[] = [
  ...
  { id:"vt3", amount:"5.000 V-Bucks",  amountEN:"5,000 V-Bucks",  priceOld:103.92,price:76.90, badge:"Oferta",     img:"/fortnite/vbucks-5000.png",   description:"Perfecto para el Pase de Batalla + varios cosméticos extra.",            descriptionEN:"Perfect for the Battle Pass + several extra cosmetics.",             slug:"pavos-5000",  format:"Digital", region:"Turquía", needsTurkey:true, tab:"pavos", tabLabel:"Recarga de Pavos", tabLabelEN:"V-Bucks Recharge", productType:"pavos" },
  { id:"vt4", amount:"13.500 V-Bucks", amountEN:"13,500 V-Bucks", priceOld:263.92,price:179.90,badge:"Mejor valor", img:"/fortnite/vbucks-13500.png",  description:"El mejor precio por V-Buck. Para coleccionistas y jugadores frecuentes.", descriptionEN:"Best price per V-Buck. For collectors and frequent players.",         slug:"pavos-13500", format:"Digital", region:"Turquía", needsTurkey:true, tab:"pavos", tabLabel:"Recarga de Pavos", tabLabelEN:"V-Bucks Recharge", productType:"pavos" },
];

export const PAQUETES: FortniteProduct[] = [
  { id:"pk5", name:"Paquete de Inicio Operación Brillante",  nameEN:"Operation Brite Starter Pack",  amount:"Outfit + Mochila + Lote de decoración (13 objetos)", amountEN:"Outfit + Back Bling + Decoration Pack (13 items)", priceOld:14.99, price:11.90, badge:"",                   img:"/fortnite/operation-brite.png",   description:"Acoge a Bombardera brillante. Incluye traje, accesorio mochilero y un lote de decoración con 13 objetos para LEGO® Fortnite.",                                                                     descriptionEN:"Welcome Bright Bomber. Includes outfit, back bling and a decoration pack with 13 items for LEGO® Fortnite.",                                                                          slug:"operation-brite-starter-pack",  format:"Digital", region:"Turquía", needsTurkey:true, tab:"paquetes", tabLabel:"Paquetes", tabLabelEN:"Bundles", productType:"paquete" },
  { id:"pk9", name:"Paquete Ruptura de la computadora central",  nameEN:"Mainframe Break Pack",  amount:"Atuendo LEGO® + Mochila + Pico + Papel + 800 paVos", amountEN:"LEGO® Outfit + Back Bling + Pickaxe + Wrap + 800 V-Bucks", priceOld:26.32, price:20.90, badge:"",                   img:"/fortnite/paquete-ruptura-central.webp",   description:"Zoe Clash y Sargento Shiba están muy dispuestos a cambiar los protocolos a su favor. ¡Asegúrate de que estén en tu bando con el paquete Ruptura de la computadora central! Incluye 800 monedas V, el atuendo Zoe Clash (con estilo LEGO®), la mochila retro Sargento Shiba, el pico Bip y Bop y el papel Locura de calcomanía.",                                                                     descriptionEN:"Zoe Clash & Sgt. Shiba are more than willing to change the protocols in their favor. Make sure they are on your side with the Mainframe Break Pack! Includes 800 V-Bucks, the Zoe Clash Outfit (with LEGO® Style), the Sgt. Shiba Back Bling, the Beep & Boop Pickaxe and the Sticker 'Em Up Wrap.",                                                                          slug:"mainframe-break-pack",  format:"Digital", region:"Turquía", needsTurkey:true, tab:"paquetes", tabLabel:"Paquetes", tabLabelEN:"Bundles", productType:"paquete" },
];

export const CLUB: FortniteProduct[] = [
  { id:"c1", name:"Club de Fortnite", nameEN:"Fortnite Crew", subtitle:"Región Turquía", subtitleEN:"Turkey Region", priceOld:39.00, price:19.90, badge:"", img:"/fortnite/club.png", description:"Activación directa en tu cuenta Epic con región TRY.", descriptionEN:"Direct activation on your Epic account with TRY region.", slug:"club-turquia", format:"Digital", region:"Turquía", needsTurkey:true, tab:"pases", tabLabel:"Pases", tabLabelEN:"Passes", productType:"club-turquia" },
  { id:"c2", name:"Club de Fortnite", nameEN:"Fortnite Crew", subtitle:"Activación Vía Xbox", subtitleEN:"Xbox Activation", priceOld:39.90, price:17.99, badge:"", img:"/fortnite/club.png", description:"Activación mensual a través de una cuenta Xbox vinculada a Epic Games.", descriptionEN:"Monthly activation through an Xbox account linked to Epic Games.", slug:"club-xbox", format:"Digital", region:"Global", needsTurkey:false, tab:"pases", tabLabel:"Pases", tabLabelEN:"Passes", productType:"club-xbox",
    monthOptions:[
